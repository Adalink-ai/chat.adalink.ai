    ...
    <>
      ...
      <div className="hidden md:flex fixed left-0 top-0 h-screen z-50">
        ...
        <Button
          ...
          className="size-12 border border-[#8F5BFF] rounded-full bg-[#8F5BFF] hover:bg-[#A970FF] text-white p-0 transition-all duration-200 hover:shadow-lg hover:shadow-[#8F5BFF]/30"
        >
